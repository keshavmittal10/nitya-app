                    ...
                    {li<arr.length-1&&(
                      <div style={{display:"flex",alignItems:"center",gap:6,margin:"6px 0"}}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                          <path d="M12 2C12 2 8 6 8 10C8 12.2 9.8 14 12 14C14.2 14 16 12.2 16 10C16 6 12 2 12 2Z" fill={day.darkText||v.c} opacity=".5"/>
                          <path d="M12 14C12 14 6 10 4 13C3 15 5 17 7 16C9 15 11 14 12 14Z" fill={day.darkText||v.c} opacity=".4"/>
                          <path d="M12 14C12 14 18 10 20 13C21 15 19 17 17 16C15 15 13 14 12 14Z" fill={day.darkText||v.c} opacity=".4"/>
                          <circle cx="12" cy="14" r="2" fill={day.darkText||v.c} opacity=".6"/>
                        </svg>
